...
// and Expiration set.
func SIG0Sign(m *Msg, k SIG0Signer) error {
	if len(m.Data) == 0 {
...
func SIG0Verify(m *Msg, y *KEY, k SIG0Signer) error {
	if len(m.Data) == 0 {
		if err := m.Pack(); err != nil {
			return err
		}
