...
func TestName(t *testing.T) {
	testcases := []struct {
		...
		{[]byte{4, 109, 105, 101, 107, 2, 110, 108, 0}, 0, 9, jump.Name},
		...
		{[]byte{98, 24, 129, 128, 0, 1, 0, 5, 0, 0, 0, 1, 4, 109, 105, 101, 107, 2, 110, 108, 0, 0, 15, 0, 1, 192, 12, 0}, 25, 27, jump.Name},
		...
		{[]byte{21, 33, 129, 128, 0, 1, 0, 5, 0, 0, 0, 1, 4, 109, 105, 101, 107, 2, 110, 108, 0, 0, 15, 0, 1, 192, 12, 0, 15, 0, 1, 0, 0, 21, 61, 0, 27, 0, 5, 4, 97, 108, 116, 49, 5, 97, 115, 112, 109, 120, 1, 108, 6, 103, 111, 111, 103, 108, 101, 3, 99, 111, 109, 0}, 26, 64, jump.RR},
		// miek.nl (4 miek 2 nl), no null byte, should terminate.
		{[]byte{4, 109, 105, 101, 107, 2, 110, 108}, 2, 0, jump.Name},
	}
