...
// will have it's buffer returned to the server's msg pool. Note that as the msgPool is copied only one of the
// messages should be written to the client, not both.
func (m *Msg) Copy() *Msg {
	return &Msg{
